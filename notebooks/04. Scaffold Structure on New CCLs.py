...
df_complete = pd.read_csv(f"{folder}v20.data.final_summary_{ccl}.txt", sep='\t')
...
df_scaffolds_grouped_sorted.to_csv(f"{folder}scaffold_split_{ccl}.txt", sep='\t', index=False)
