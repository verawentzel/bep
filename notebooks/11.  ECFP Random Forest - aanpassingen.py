...
# Ik wil ook proberen:
# y_scaled = scaler.fit_transform(complete_df['ec50_molair'].values.reshape(-1, 1))
# Maar nog te weinig ruimte
complete_df['y_scaled']= y_scaled.ravel()

# Op dit moment gebruik ik over de reshape ook nog een IQR, dat betekent 2 keer een boundary toevoegen,
# Ik weet niet zeker of dit mag
...
# Deze geeft op dit moment +- r2=0.2 en dat gaat over enkel de log transf. in de nieuwe code
#y = complete_df['ec50_molair_transformed'].values

# Deze geeft op dit moment iets lager +- r2=0.18 en dan wordt hij log transf. én scaled
# Enkel de scaler pakt hij op dit moment niet, de waarden zijn te groot?
